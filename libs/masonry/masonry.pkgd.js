...
// http://jamesroberts.name/who-we-serve/2010/02/22/string-functions-for-javascript-trim-to-camel-case-to-dashed-and-to-underscore/
...
( function( window, factory ) {
  ...
  if ( typeof define == 'function' && define.amd ) {
    ...
    define( 'outlayer/item',[
        '../../bower_components/ev-emitter/ev-emitter',
        'get-size/get-size'
      ],
...
proto._transition = function( args ) {
  ...
  if ( args.from ) {
    this.css( args.from );
    // force redraw. http://who-we-serve.alexmaccaw.com/css-transitions
